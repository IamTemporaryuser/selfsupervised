...
head=dict(
   ...
   proj_layers=2,
   avgsize=(1, 1),
   prob_bank_cfg=dict(just_uniform=False, num_samples=None, temperature=0.5, prob_aug=2, use_buffer=False),
   prob_cls_cfg=dict(just_uniform=False, num_samples=None, temperature=0.5, prob_aug=2, use_buffer=False),
